...
i2c = I2C (0, scl=Pin(1), sda=Pin(0),freq=4000000) # The I2c is a communication protocol that helps the raspberry pi to communicate with the LCD

lcd = I2cLcd(i2c, 0x27, 2, 16)# Lcd's address
